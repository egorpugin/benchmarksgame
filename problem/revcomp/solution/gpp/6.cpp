...
static constexpr char lookup[] = {
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 0
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 16
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 32
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 48

    ʼ ʼ, ʼTʼ, ʼVʼ, ʼGʼ, ʼHʼ, ʼ ʼ, ʼ ʼ, ʼCʼ, // @ABCDEFG (64-71)
    ʼDʼ, ʼ ʼ, ʼ ʼ, ʼMʼ, ʼ ʼ, ʼKʼ, ʼNʼ, ʼ ʼ, // HIJKLMNO (72-79)
    ʼ ʼ, ʼ ʼ, ʼYʼ, ʼSʼ, ʼAʼ, ʼAʼ, ʼBʼ, ʼWʼ, // PQRSTUVW (80-87)
    ʼ ʼ, ʼRʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, // XYZ[\]^_ (88-95)
    ʼ ʼ, ʼTʼ, ʼVʼ, ʼGʼ, ʼHʼ, ʼ ʼ, ʼ ʼ, ʼCʼ, // `abcdefg (96-103)
    ʼDʼ, ʼ ʼ, ʼ ʼ, ʼMʼ, ʼ ʼ, ʼKʼ, ʼNʼ, ʼ ʼ, // hijklmno (104-111)
    ʼ ʼ, ʼ ʼ, ʼYʼ, ʼSʼ, ʼAʼ, ʼAʼ, ʼBʼ, ʼWʼ, // pqrstuvw (112-119)
    ʼ ʼ, ʼRʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, ʼ ʼ, // xyz{|}~  (120-127)

    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 128
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 144
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 160
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 176
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 192
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 208
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 224
    ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ,ʼ ʼ, // 240
};

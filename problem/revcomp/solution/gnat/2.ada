...
;
   ...
   begin
      ...
      select
         ...
         accept Done_Reading_Start_Writing (Reached_End_Of_File : out Boolean) d
o
...
begin
   ...
   if Multitasking_Version_Desired then -- Do computation concurrently with Inpu
t
      ...
      begin
         ...
         loop
            ...
            -- Task i is done reading so we can unblock task i+1 to start readin
g:
...
package Text_Input is
   ...
   type String_Pointer (Size : Positive) is new Ada.Finalization.Limited_Control
led with
       record
      ...
      loop
         ...
         begin
            ...
            if Line(LineʼFirst) = Section_Marker then
               ...
               Data_Buffer(Data_Length+1 .. Data_Length+Present_Line_Length):=Li
ne;

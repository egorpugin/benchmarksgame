...
;
      ...
      task Writer is
         ...
         entry Set (Nucleotide_Length   : in Fragment_Lengths;
                    Nucleotide_Fragment : in Fragments.Fragment := Fragments.Nul
l_Fragment);
      end Writer;
...
--  Calculate frequency of occurrence of the nucleotides:
            ...
            function Number_Counted (Nucleotide_Fragment : Fragment) return Natu
ral;
...
;
            function Fragment_Of (Element : not null Element_Access) return Frag
ment;
 ...
 is
            ...
            function Number_Counted (Nucleotide_Fragment : Fragment) return Natu
ral is
               The_Element : constant Element_Access := Table.Get (Nucleotide_Fr
agment);
            begin
         ...
         if Nucleotide_Fragment = Fragments.Null_Fragment then
            ...
            begin
               ...
               Get_Sort_Put : declare
                  Data : array (0 .. Num_Table_Entries) of Calculator.Element_Ac
cess;
...
");
   Fragment_6  : constant Fragments_6.Fragment := Fragments_6.To_Fragment ("GGTA
TT");
   Fragment_12 : constant Fragments_12.Fragment := Fragments_12.To_Fragment ("GG
TATTTTAATT");
   Fragment_18 : constant Fragments_18.Fragment := Fragments_18.To_Fragment ("GG
TATTTTAATTTATAGT");

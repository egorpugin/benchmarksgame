...
//  -pipe -Wall -O3 -ffast-math -fno-finite-math-only -march=native -mfpmath=sse
 -msse3 -fopenmp
...
inline void calcSum(__m128d *r, __m128d *i, __m128d *sum, __m128d *init_r, __m12
8d init_i)
{
...
int main(int argc, char ** argv)
{
    ...
    long pad = ((headerLength + 7) & ~7) - headerLength; // pad aligns pixels on
 8
    ...
    else
    {
        ...
        for(long y=0; y<wid_ht; y++)
        {
            ...
            {
                ((unsigned long *)pixels)[rowstart + x/64] = mand64(r0+x/2, init
_i);
            }
        }
    }

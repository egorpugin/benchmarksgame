...
unsafe fn calc_inv_distance(delta_pos: &[__m256d; 12]) -> [__m256d; 3] {
    ...
    for k in 0..3 {
        ...
        let y1 = _mm256_permute2f128_pd::<0x30>(tmp0, tmp1);
...
unsafe fn energy(position: &[__m256d; 5], velocity: &[__m256d; 5]) -> f64 {
    ...
    for k in 0..5 {
        let velocity2: [f64; 4] = transmute(_mm256_mul_pd(velocity[k], velocity[
k]));
...
unsafe fn advance(n: i32, position: &mut [__m256d; 5], velocity: &mut [__m256d;
5]) {

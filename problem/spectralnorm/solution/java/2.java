...
{
    private static final NumberFormat formatter = new DecimalFormat ("#.00000000
0");
    ...
    private static class Approximate extends Thread
    {
        ...
        public Approximate (double[] u, double[] v, double[] tmp, int rbegin, in
t rend)
        {
            super ();
        ...
        private final void MultiplyAtAv (final double[] v, double[] tmp, double[
] AtAv)
        {
            try
            {
